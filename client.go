...
func main() {
	...
	// GET 요청
	getURL := "http://127.0.0.1:5000/note"
    ...
    postURL := "http://127.0.0.1:5000/note"
	//fmt.Printf("Request to Address : %s\n", postURL)
    ...
    // DELETE 요청
    deleteURL := "http://127.0.0.1:5000/note/1"
	//fmt.Printf("Request to Address : %s\n", deleteURL)
    ...
    patchURL := "http://127.0.0.1:5000/note/2"
	//fmt.Printf("Request to Address : %s\n", patchURL)
	...
	putURL := "http://127.0.0.1:5000/note/2"
	//fmt.Printf("Request to Address : %s\n", putURL)
