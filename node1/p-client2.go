...
func main() {
	...
	//fmt.Println("GET Response Status:", resp.Status)
	//fmt.Println("GET Response Body:", string(body))
	//log.Println("GET Request took:", elapsed)
	...
	//log.Println("POST Request took:", elapsed)
    ...
    //log.Println("DELETE Request took:", elapsed)
    ...
    //log.Println("PATCH Request took:", elapsed)


	// PUT 요청
	putData := []byte(`{"title": "updated memo title", "body": "updated memo body"}`)
	putURL := "http://127.0.0.1:8080/note/2"
	//fmt.Printf("Request to Address : %s\n", putURL)
	...
	//log.Println("PUT Request took:", elapsed)
}
